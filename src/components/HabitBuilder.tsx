...
export function HabitBuilder({
  ...
  return (
    <div className="space-y-4">
      <div>
        <p className="label mb-0">Sua agenda semanal de hábitos</p>
          ...
          <div key={habit.id} className="rounded-xl border border-base-border bg-base-surface2 p-4">
            <div className="flex items-start gap-3">
              <div className="flex-1 space-y-3">
                <input
                  type="text"
                  placeholder="Ex: Treino de força 40min"
                ...
                <input
                  type="text"
                  placeholder="Como executar: horário, duração, técnica, quantidade"
